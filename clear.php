    ...
    <!-- Collect the nav links, forms, and other content for toggling -->
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <ul class="nav nav-pills" style="padding-left:100px; font-family:Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif; font-size:18px;">
                ...
                <li><a href="bursary.php">Clearance Process</a></li>
...
<?php 
//$id = $_SESSION['id'];
$sql="select * from dimage where student_id='$del'";
...
<footer class="panel-footer" style="background-color:#15ACEC; margin-top:40%">
