    ...
    <br>
     <nav class="navbar navbar-default">
		<div class="container-fluid">
            ...
            <center><h4 style="margin:auto">Bursary Clearance</h4></center>
            ...
            <div style="background-color:#b9e5f3;" class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <li class="active"><a href="bursary.php">Student List</a></li>
                <li><a href="burapprove.php">Approved Student</a></li>
                <li><a href="burdisapprove.php">Disapproved Student</a></li>
                <li><a href="#">Mail</a></li>
       ...
       <?php 
	   $yu = "SELECT id, matric_no, l_name, f_name FROM adminreg WHERE burstatus = 'Pending'";
	   $reslt = $conn->query($yu);
	   if ($reslt->num_rows > 0) {	
        ...
        <td><a href="clearb.php?del=<?php echo $id?>">Details <span class="glyphicon glyphicon-open-file"></span></a></td>
        <td><a href="acceptb.php?id=<?php echo $id?>"><span class="glyphicon glyphicon-check" style="font-size:30px; color:green"></span></a></td>
		<td><a href='rejectb.php?id=<?php echo $id?>'><span class='glyphicon glyphicon-remove' style="font-size:30px; color:red"></span></a></td>
