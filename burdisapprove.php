     ...
     <nav class="navbar navbar-default">
		<div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <li ><a href="bursary.php">Student List</a></li>
                <li><a href="burapprove.php">Approved Student</a></li>
                <li class="active"><a href="burdisapprove.php">Disapproved Student</a></li>
                <li><a href="#">Mail</a></li>
       ...
       <?php 
	   $yu = "SELECT id, matric_no, l_name, f_name FROM adminreg WHERE burstatus = 'Disapprove'";
	   $reslt = $conn->query($yu);
	   if ($reslt->num_rows > 0) {	
