     ...
     <nav class="navbar navbar-default">
		<div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <li><a href="#">Departmental Clearance</a></li>
                <li ><a href="bur-clr.php">Bursary Clearance</a></li>
                <li class="active"><a href="fal-clr.php">Faculty Clearance</a></li>
       ...
       <form style="padding-left:0%;" class="form-group" enctype="multipart/form-data" action="fal-clr.php" method="post">
       <br>
       <div class="form-control">
       <select value="Choose Document" name="name">
       		<option>Falculty Receipt 100L</option>
            <option>Falculty Receipt 200L</option>
            <option>Falculty Receipt 300L</option>
            <option>Falculty Receipt 400L</option>
       </select>
       </div>
       <br>
       <div class="form-control">
...
$query= "INSERT INTO fimage (name,student_id,imagename) VALUES ('$name','$userid','$image')";
		...
		<h5>Uploaded Receipt Files</h5>
		 <table class="table table-bordered">
              ...
              <tbody>
										...
										<?php 
							$userid = $_SESSION['userid'];
							$query= "SELECT * FROM fimage WHERE student_id ='$userid'";
