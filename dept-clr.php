...
<div class="container-fluid">
     ...
     <nav class="navbar navbar-default">
		<div class="container-fluid" >
            ...
            <div style="background-color:#b9e5f3;" class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <li class="active"><a href="dept-clr.php">Departmental Clearance</a></li>
       ...
       <div class="col-md-9">
       <br>
       <h4>Departmental Clearance</h4>
       <form style="padding-left:0%;" class="form-group" enctype="multipart/form-data" action="dept-clr.php" method="post">
       <br>
       <div class="form-control">
       <select value="Choose Document" name="name">
       		<option>Departmental Receipt 100L</option>
            <option>Departmental Receipt 200L</option>
            <option>Departmental Receipt 300L</option>
            <option>Departmental Receipt 400L</option>
       </select>
       </div>
       <br>
       <div class="form-control">
    ...
    //if (!empty($image))
    //  $query="SELECT * FROM dimage WHERE student_Id ='$userid'";
     // $result=mysqli_query($conn,$query);
     // $row=mysqli_fetch_array($result);
    ///  if (!empty($row)) {
       // echo "<script type='text/javascript'>alert('The file already exists')</script>";
      //}else{
    ...
    echo "<script>alert('Please Try Again, Image not Accepted.... Input a trusted file!!!!!')</script>";
      ...
      $query= "INSERT INTO dimage (name,student_id,imagename) VALUES ('$name','$userid','$image')";
