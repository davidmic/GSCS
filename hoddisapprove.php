    ...
    <br>
     <nav class="navbar navbar-default">
		<div class="container-fluid">ssss
            ...
            <h4 style="margin-left:230px">Departmental Clearance</h4>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <li><a href="hod.php">Student List</a></li>
                <li><a href="hodapprove.php">Approved Student</a></li>
                <li class="active"><a href="hoddisapprove.php">Disapproved Student</a></li>
                <li><a href="#">Mail</a></li>
       ...
       <?php 
	   $yu = "SELECT id, matric_no, l_name, f_name FROM adminreg WHERE hodstatus = 'Disapprove'";
	   $reslt = $conn->query($yu);
	   if ($reslt->num_rows > 0) {	
