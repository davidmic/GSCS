     ...
     <nav class="navbar navbar-default">
		<div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <li class=""><a href="#">Student Bio-Data</a></li>
                <li><a href="#">Departmental Clearance</a></li>
                <li><a href="#">Bursary Clearance</a></li>
                <li><a href="#">Check Clearance Status</a></li>
       ...
       <select class="form-control">
          ...
          <option>Departmental Faculty</option>
          <option>University Bursar</option>
          <option>University Library</option>
          <option>University Health Service</option>
          <option>Sport Unit</option>
          <option>Security Unit</option>
          <option>Student Affairs</option>
          <option>Academic Affairs</option>
       </select>
       <label for="msg">Message: </label>
       <textarea rows="10" class="form-control" style="border:1px solid blue;"></textarea>
       <br> 
